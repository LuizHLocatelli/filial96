 ...
 * Use `<div className="flex-1 min-h-0 overflow-y-auto touch-pan-y overscroll-contain relative z-20" data-scroll-lock-ignore>` diretamente no lugar deste componente.
 * 
...
export function StandardDialogContent({
  ...
  return (
    <div
      className={cn(
        "flex-1 min-h-0 overflow-y-auto touch-pan-y overscroll-contain relative z-20 overscroll-contain scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent",
