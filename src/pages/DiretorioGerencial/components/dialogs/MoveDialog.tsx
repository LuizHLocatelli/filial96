...
import { ArrowRightLeft, Loader2, Folder, Home } from "lucide-react";
...
interface MoveDialogProps {
  ...
  onMove: (targetPastaId: string | null) => Promise<void>;
  itemName: string;
          ...
          <ScrollArea className="h-[300px] rounded-md border">
            <div className="p-2 space-y-1">
              ...
              >
                ...
                Diretório Raiz
                {isRootSelected && (
                  <span className="ml-auto text-xs">Selecionado</span>
                )}
              </Button>
