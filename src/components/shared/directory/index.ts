/**
 * Componentes compartilhados do Diretório
 *
 * Nota: Estes componentes são mantidos no módulo crediario e re-exportados
 * aqui para facilitar o uso por outros módulos.
 */

export { DirectoryDialogs } from "@/components/crediario/diretorio/components/DirectoryDialogs";
