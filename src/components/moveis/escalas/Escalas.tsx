...
export default function Escalas() {
  ...
  const startDateStr = format(new Date(current.getFullYear(), current.getMonth(), 1), "yyyy-MM-dd");
  const endDateStr = format(new Date(current.getFullYear(), current.getMonth() + 2, 0), "yyyy-MM-dd");
