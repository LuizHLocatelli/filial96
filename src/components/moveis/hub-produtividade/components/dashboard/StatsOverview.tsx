            ...
            >
              <CardContent className="p-3 sm:p-4 space-y-2">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="p-1.5 sm:p-2 rounded-lg bg-white/50 dark:bg-background/50 group-hover:bg-white/80 dark:group-hover:bg-background/80 transition-colors flex-shrink-0">
                ...
                {typeof card.progress === 'number' && (
                  <div className="space-y-1 pt-1">
                    ...
                    <Progress 
                      value={card.progress} 
                      className="h-1.5 bg-white/50 dark:bg-background/50" 
                    />
                  </div>
                )}
                  ...
                  {card.sections.map((section, sectionIndex) => (
                    <div key={sectionIndex} className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5">
                        <div className={cn("w-1.5 h-1.5 rounded-full", section.color)} />
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="w-full text-xs bg-white/30 dark:bg-background/30 hover:bg-white/50 dark:hover:bg-background/50 mt-2 p-2 h-auto"
                >
                  Acessar
                </Button>
              </CardContent>
          ...
          <CardContent className="p-4 lg:p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="font-bold text-emerald-600 dark:text-emerald-400 text-xl md:text-2xl">
              ...
              <div className="text-center">
                <div className="font-bold text-blue-600 dark:text-blue-400 text-xl md:text-2xl">
              ...
              <div className="text-center">
                <div className="font-bold text-orange-600 dark:text-orange-400 text-xl md:text-2xl">
