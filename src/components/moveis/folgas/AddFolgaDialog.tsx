    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-2.5 sm:space-y-3 py-1">
          ...
          <div className="space-y-1 sm:space-y-1.5">
            <label htmlFor="consultor-dialog-moveis" className="text-xs font-medium">
              Consultor
            </label>
            <Select
            ...
            >
              <SelectTrigger id="consultor-dialog-moveis" className="w-full text-xs">
          ...
          <div className="space-y-1 sm:space-y-1.5">
            <label htmlFor="motivo-dialog-moveis" className="text-xs font-medium">
              Motivo (opcional)
            </label>
            <Textarea
              id="motivo-dialog-moveis"
