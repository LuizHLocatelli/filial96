...
// Configuração específica para o módulo de Móveis
const moveisFolgasConfig: UseFolgasConfig = {
  tableName: "moveis_folgas",
  consultantRole: "consultor_moveis",
  moduleTitle: "Folgas",
  moduleDescription: "Gerenciamento de folgas dos consultores de móveis",
};
  ...
  return (
    <div className="w-full mx-auto animate-fade-in space-y-4 sm:space-y-6 px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 max-w-7xl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold">{moveisFolgasConfig.moduleTitle}</h2>
          <p className="text-sm text-muted-foreground">{moveisFolgasConfig.moduleDescription}</p>
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="mt-8">
          <FolgasList
            ...
            description="Gerencie todas as folgas registradas dos consultores de móveis"
          />
        </div>
      </div>
      ...
      <AddFolgaDialog
        ...
        description="Registre uma nova folga para um consultor de móveis"
      />
