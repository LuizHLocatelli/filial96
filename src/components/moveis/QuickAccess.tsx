...
import { FileText, FolderArchive, ShoppingCart, Calendar, Star } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <span className={`font-medium text-center ${compact 
        ...
        : 'text-base sm:text-lg'} ${isDarkMode ? 'text-white' : 'text-primary'}`}
      >
        {title}
      </span>
    </motion.div>
  ...
  return (
    <div className={compact ? "" : "animate-fade-in"}>
      ...
      >
        <AccessCard
          title="Orientações"
          icon={<FileText size={iconSize} className={isDarkMode ? "text-blue-300" : "text-blue-700"} />}
        ...
        <AccessCard
          title="Diretório"
          icon={<FolderArchive size={iconSize} className={isDarkMode ? "text-green-300" : "text-green-700"} />}
        ...
        <AccessCard
          title="Venda O"
          icon={<ShoppingCart size={iconSize} className={isDarkMode ? "text-purple-300" : "text-purple-700"} />}
        ...
        <AccessCard
          title="Produto Foco"
          icon={<Star size={iconSize} className={isDarkMode ? "text-yellow-300" : "text-yellow-600"} />}
          onClick={() => handleNavigation("produto-foco")}
