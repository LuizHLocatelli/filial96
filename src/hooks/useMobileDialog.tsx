...
// IMPORTANTE: overflow-hidden deve estar no DialogContent para rolagem funcionar corretamente
export const DIALOG_SIZES = {
  small: "sm:max-w-md max-h-[75dvh] sm:max-h-[75vh] overflow-hidden flex flex-col",
  medium: "sm:max-w-2xl max-h-[75dvh] sm:max-h-[75vh] overflow-hidden flex flex-col",
  default: "max-w-4xl max-h-[75dvh] sm:max-h-[75vh] overflow-hidden flex flex-col",
  large: "max-w-5xl max-h-[75dvh] sm:max-h-[75vh] overflow-hidden flex flex-col",
  extraLarge: "max-w-6xl max-h-[75dvh] sm:max-h-[75vh] overflow-hidden flex flex-col",
...
export function useMobileDialog() {
  ...
  const getMobileDialogProps = (size: DialogSizeKey = "default", maxHeight?: string) => {
    const baseClasses = isMobile
      ? `w-[calc(100%-2rem)] max-w-[calc(100%-2rem)] ${maxHeight ? `max-h-[${maxHeight}]` : 'max-h-[75dvh] sm:max-h-[75vh]'} rounded-2xl overflow-hidden flex flex-col p-0`
      : DIALOG_SIZES[size];
